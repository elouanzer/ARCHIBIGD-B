...
def consumer_from_kafka(topic,stations):
    ...
    consumer = KafkaConsumer("velib-stations", bootstrap_servers='localhost:9092',auto_offset_reset="earliest", enable_auto_commit=True, auto_commit_interval_ms=1000)
